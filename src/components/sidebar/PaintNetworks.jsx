...
export default class PaintNetworks extends React.PureComponent {
  render() {
    const { onAutoPaintNodesClick, onAutoPaintModuleIdsClick, onRemoveColorsClick } = this.props;
    ...
    return <>
      ...
      <Button.Group {...buttonProps}>
        <Popup
          ...
          inverted size="small"
          trigger={<Button content="Auto paint nodes" onClick={onAutoPaintNodesClick}/>}/>
        <Popup
          ...
          inverted size="small"
          trigger={<Button content="Auto paint module ids" onClick={onAutoPaintModuleIdsClick}/>}/>
      </Button.Group>
