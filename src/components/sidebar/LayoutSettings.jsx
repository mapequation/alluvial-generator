...
const GreySlider = (props) => (
  <Slider color="grey" value={props.start} settings={props} />
);
...
export default class LayoutSettings extends PureComponent {
      ...
      <>
        ...
        >
          <GreySlider
            ...
            step={0.1}
            onChange={(value) =>
              dispatch({ type: "streamlineFraction", value })
            }
          />
        </LabelForSlider>
        <LabelForSlider
        ...
        >
          <GreySlider
            ...
            step={0.1}
            onChange={(value) =>
              dispatch({ type: "moduleFlowThreshold", value: 1 - value / 100 })
            }
          />
        </LabelForSlider>
        <LabelForSlider
        ...
        >
          <GreySlider
            ...
            step={0.01}
            onChange={(value) =>
              dispatch({ type: "streamlineThreshold", value })
            }
          />
        </LabelForSlider>
        <LabelForSlider
        ...
        >
          <GreySlider
            ...
            onChange={(transparency) =>
              dispatch({ type: "streamlineOpacity", value: 1 - transparency })
            }
          />
        </LabelForSlider>
        <LabelForSlider
        ...
        >
          <GreySlider
            ...
            step={1 / 2000}
            onChange={(value) =>
              dispatch({ type: "duration", value: 1 / value })
            }
          />
        </LabelForSlider>
        <div style={{ clear: "both", paddingTop: "0.5em" }}>
          ...
          <MyCheckbox
            ...
            onChange={(e, { checked }) =>
              dispatch({ type: "showModuleId", value: checked })
            }
          ...
          <MyCheckbox
            ...
            onChange={(e, { checked }) =>
              dispatch({ type: "showModuleNames", value: checked })
            }
          ...
          <MyCheckbox
            ...
            onChange={(e, { checked }) =>
              dispatch({ type: "showNetworkNames", value: checked })
            }
          ...
          <MyCheckbox
            ...
            checked={dropShadow}
            onChange={(e, { checked }) =>
              dispatch({ type: "dropShadow", value: checked })
            }
        ...
        <DefaultHighlightColor
          ...
          onChange={(value) =>
            dispatch({ type: "defaultHighlightColor", value })
          }
        />
      </>
    );
